...
map_rea <- highchart(type = 'map') %>%
  ...
  hc_subtitle(
    text = "Depuis Mars 2020 <br> Paris présente le plus fort taux de r?animations devant la Guyane (Max taux d'hospitalisation)",
    style = list(
      color = "#000000", 
      fontStyle = "italic",
      fontSize = "18px"
...
Chart_taux_ineg = 
  ...
  hchart(
    ...
    name = c("Groupe 1 : Côtes-d'armor, Ille-et-Vilaine, Maine-et-Loire, Mayenne, Vendée","Groupe 2 : Aude, Guadeloupe, Gard, Haute-Corse, Seine-Saint-Denis"), 
    showInLegend = TRUE, 
    fillOpacity = 0.3,
  ...
  hc_chart(style = list(fontFamily = "Rubik")) %>%
  hc_title(
    text = "Taux d'hospitalisation et de réanimations suivant les aides exceptionnelles COVID", 
    style = list(
      color = "#000000", 
      fontWeight = "bold",
      fontSize = "28px"
  ...
  hc_subtitle(
    text = "5 premiers départements vs 5 derniers départements ", 
    style = list(
      color = "#000000", 
      fontStyle = "italic",
      fontSize = "18px"
